    ...
    <View className="flex-1 bg-primary">
      <View className="flex-row items-center justify-center p-4 bg-secondary">
        ...
        <View className="flex-1 items-center">
          <Text className="text-3xl font-jbold mr-5 text-primary">{meal}</Text>
        </View>
      </View>
        ...
        <View className="flex-row justify-center w-full mt-8 items-center border-2 border-primary p-3">
          <View className="flex-1 items-center">
            ...
            <View className="flex-row justify-between w-full mt-4">
              <Text className="font-jbold text-l text-primary">Protein</Text>
              <View className="flex-row mt-1">
                <Text className="font-jlight text-xs text-primary">
      ...
      <View className="px-5 bg-primary">
        <Text className="font-jbold text-3xl mt-5 text-secondary">Meals</Text>
                        ...
                        <View className="text-left flex-row">
                          <TouchableOpacity
                            onPress={async () => {
                              ...
                              console.log("User's current nutritional info:", {
                              ...
                              const updatedUserInfo = {
                                ...
                                carbs:
                                  userInfo.carbs +
                                  Math.round(parseFloat(meal.nutrients.carbs)),
                                fat:
                                  userInfo.fat +
                                  Math.round(parseFloat(meal.nutrients.fat)),
                              };
                              try {
                                await updateUser(userInfo.$id, updatedUserInfo); // Use userInfo.$id as the document ID
